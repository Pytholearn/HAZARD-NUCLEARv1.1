...
ctypes.windll.kernel32.SetConsoleTitleW("HAZARD-NUCLEAR-v1.1")
print("                                                           v 1.1 ")
print("                               ███[yellow]╗   [/yellow]██[yellow]╗[/yellow]██[yellow]╗   [/yellow]██[yellow]╗ [/yellow]██████[yellow]╗[/yellow]██[yellow]╗[/yellow]     ███████[yellow]╗[/yellow] █████[yellow]╗[/yellow] ██████[yellow]╗ [/yellow]                     [yellow on white]For IRAN")
print("                               ████[yellow]╗  [/yellow]██[yellow]║[/yellow]██[yellow]║   [/yellow]██[yellow]║[/yellow]██[yellow]╔════╝[/yellow]██[yellow]║[/yellow]     ██[yellow]╔════╝[/yellow]██[yellow]╔══[/yellow]██[yellow]╗[/yellow]██[yellow]╔══[/yellow]██[yellow]╗[/yellow]")
print("                               ██[yellow]╔[/yellow]██[yellow]╗ [/yellow]██[yellow]║[/yellow]██[yellow]║  [/yellow] ██[yellow]║[/yellow]██[yellow]║[/yellow]     ██[yellow]║[/yellow]     █████[yellow]╗ [/yellow] ███████[yellow]║[/yellow]██████[yellow]╔╝[/yellow]")
print("                               ██[yellow]║╚[/yellow]██[yellow]╗[/yellow]██[yellow]║[/yellow]██[yellow]║  [/yellow] ██[yellow]║[/yellow]██[yellow]║[/yellow]     ██[yellow]║[/yellow]     ██[yellow]╔══╝ [/yellow] ██[yellow]╔══[/yellow]██[yellow]║[/yellow]██[yellow]╔══[/yellow]██[yellow]╗[/yellow]")
print("                               ██[yellow]║ ╚[/yellow]████[yellow]║╚[/yellow]██████[yellow]╔╝╚[/yellow]██████[yellow]╗[/yellow]███████[yellow]╗[/yellow]███████[yellow]╗[/yellow]██[yellow]║ [/yellow] ██[yellow]║[/yellow]██[yellow]║ [/yellow] ██[yellow]║[/yellow]")
print("                               [yellow]╚═╝  ╚═══╝ ╚═════╝  ╚═════╝╚══════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝[/yellow]")
print("                                                      [yellow]IRAN ON TOP!")                                                        
Write.Print("  >SMS BOMBER:)\n", Colors.gray, interval=0.000001)
Write.Print("  >MADE BY: HAZARD TEAM\n", Colors.gray, interval=0.000001)
Write.Print("  >HaZaRd#4058 \n", Colors.gray, interval=0.000001)
Write.Print("------------------------------------------------------------------------------------------------------------------------\n", Colors.yellow, interval=0.009)	
try:
...
while True:
    phone = is_phone(input(Fore.LIGHTBLACK_EX+'Enter Target Number >>> '))
    if phone:
        break
try:
